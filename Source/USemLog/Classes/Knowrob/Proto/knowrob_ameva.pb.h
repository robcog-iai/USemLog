...
inline std::string* DrawMarkerAtParams::unsafe_arena_release_material() {
  // @@protoc_insertion_point(field_unsafe_arena_release:sl_pb.DrawMarkerAtParams.material)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000004u;
  return material_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DrawMarkerAtParams::unsafe_arena_set_allocated_material(
    std::string* material) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (material != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  ...
  material_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      material, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:sl_pb.DrawMarkerAtParams.material)
}
...
inline std::string* DrawMarkerTrajParams::unsafe_arena_release_material() {
  // @@protoc_insertion_point(field_unsafe_arena_release:sl_pb.DrawMarkerTrajParams.material)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000004u;
  return material_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void DrawMarkerTrajParams::unsafe_arena_set_allocated_material(
    std::string* material) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (material != nullptr) {
    _has_bits_[0] |= 0x00000004u;
  ...
  material_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      material, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:sl_pb.DrawMarkerTrajParams.material)
}
