...
* 
*/
struct FOwlSemanticMapIAISupermarket : public FOwlSemanticMapIAI
{
public:
	// Default constructor
	FOwlSemanticMapIAISupermarket() 
	{
		AddDefaultValues();
	}
...
protected:
	...
	void AddImports()
	{
		...
		OntologyImports.ChildNodes.Add(FOwlNode(OwlImports,
			FOwlAttribute(RdfResource, FOwlAttributeValue("package://knowrob_common/owl/knowrob_u_TODO_DM.owl"))));
	};
	...
	void AddPropertyDefinitions()
	{
		...
		PropertyDefinitions.Add(FOwlNode(OwlOP, FOwlAttribute(RdfAbout, FOwlAttributeValue("knowrob", "describedInMapTODO_DM"))));
	}
	...
	void  AddDatatypeDefinitions()
	{
		...
		DatatypeDefinitions.Add(FOwlNode(OwlDP, FOwlAttribute(RdfAbout, FOwlAttributeValue("knowrob", "pathToCadModelTODO_DM"))));
	}
	...
	void AddClassDefinitions()
	{
		...
		ClassDefinitions.Add(FOwlNode(OwlClass, FOwlAttribute(RdfAbout, FOwlAttributeValue("knowrob", "VectorTODO_DM"))));
	}
};
